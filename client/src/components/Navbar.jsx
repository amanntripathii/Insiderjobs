...
const Navbar = () => {
    ...
    const {openSignIn} = useClerk() //To open the sign in page from clerk
    const {user} = useUser() //To get the user details from clerk

    const navigate = useNavigate() //To navigate to the job search page
