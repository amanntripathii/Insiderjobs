...
const Applications = () => {
  ...
  const [isEdit, setIsEdit] = useState(false);  //To check if the user wants to edit their resume
        ...
        <table className='min-w-full bg-white border rounded-lg'>
          <thead>
            <tr>
              ...
              <th className='py-3 px-4 border-b text-left max-sm:hidden'>Location</th> {/*hide on mobile screen*/}
              <th className='py-3 px-4 border-b text-left max-sm:hidden'>Date</th> {/*hide on mobile screen*/}
