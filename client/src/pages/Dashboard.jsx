...
const Dashboard = () => {
  ...
  const logoutHandler = () => { // function to handle logout
  ...
  useEffect(() => { // if user is logged in then redirect to dashboard/manage-jobs
    if (companyData) {
  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='flex'>
        ...
        {/* Left sidebar (add job, manage job & view applications) */}
        <div className='inline-block min-h-screen bg-gray-50/80'>
